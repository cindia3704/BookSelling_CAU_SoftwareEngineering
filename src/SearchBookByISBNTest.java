...
class SearchBookByISBNTest {
	AddElement addElement= new AddController();
	SearchBook search= new SearchBookByISBN();
	...
	void testSearchBookByISBN() {
		Book[] bookList2= {b2};
		Book[] searchedBooks=search.searchBooks(bookList, "1020152422");
		assertSame(bookList2[0],searchedBooks[0]);
		assertFalse((bookList2[0].equals(b3)));
	}
}
