...
class SearchBookByPublisherTest {

	AddElement addElement= new AddController();
	SearchBook search= new SearchBookByPublisher();
	...
	void setUp() throws Exception {
		 ...
		 b3= new Book(1,"cindia","Aladin","1020152431","Prince Ali","mermaid ","20201203","23000","1");
	...
	void testSearchBookByPublisher() {
		...
		Book[] searchedBooks=search.searchBooks(bookList, "mermaid corp");
