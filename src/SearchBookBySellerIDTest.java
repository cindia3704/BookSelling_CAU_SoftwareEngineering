...
class SearchBookBySellerIDTest {

	AddElement addElement= new AddController();
	SearchBook search= new SearchBookBySellerID();
	...
	@Test
	void testSearchBookBySellerID() {
		Book[] bookList2= {b2,b3};
		Book[] searchedBooks=search.searchBooks(bookList, "cindia");
